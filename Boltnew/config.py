# ملف إعدادات التحقق لـ SheerID

# إعدادات واجهة برمجة تطبيقات SheerID (API)
...
# إعدادات المدرسة - فروع جامعة بنسلفانيا الحكومية (Pennsylvania State University)
SCHOOLS = {
    '2565': {
        'id': 2565,
        'idExtended': '2565',
...
# معاملات UTM (تتبع التسويق)
# إذا لم تكن هذه المعاملات ضمن الـ URL، سيتم إضافتها تلقائياً
DEFAULT_UTM_PARAMS = {
    'utm_source': 'gemini',
